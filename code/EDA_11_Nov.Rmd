...
# new column in "case_stage_by_file" matching with "dfa_file_cases" to check if filed case is DEFFTA
case_stage_by_file$event_code <- ifelse(is.na(match(case_stage_by_file$file_number, dfa_file_cases$file_number)),"Other", "DEFFTA")
